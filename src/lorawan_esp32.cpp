...
void Lorawan_esp32::sendBytesAtInterval(
    uint8_t* payload, size_t length, unsigned interval, uint8_t port, uint8_t confirm)
{
...
void onEvent(ev_t ev)
{
    ...
    case EV_TXCOMPLETE:
        ...
        /*	if (cyclique)
           ...
           sec2osticks(TX_INTERVAL), pLoRaWAN->txMessage);
                }*/
        break;
    case EV_LOST_TSYNC:
#ifdef DEBUG
