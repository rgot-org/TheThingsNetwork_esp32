...
namespace TTN_esp32_LMIC
{
    ...
    class HalConfiguration_heltec_wifi_lora_32 : public HalConfiguration_t
    {
    public:
    ...
    static HalConfiguration_heltec_wifi_lora_32 myConfig;
    ...
    const HalPinmap_t* GetPinmap_heltec_wifi_lora_32(void) { return &myPinmap; }
