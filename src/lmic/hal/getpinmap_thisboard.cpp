...
#elif defined(ARDUINO_HELTEC_WIFI_LORA_32) || defined(WIFI_LoRa_32)
        return GetPinmap_heltec_wifi_lora_32();
#elif defined(ARDUINO_HELTEC_WIFI_LORA_32_V2) || defined(WIFI_LoRa_32_V2)
        return GetPinmap_heltec_wifi_lora_32_V2();
#elif defined(ARDUINO_TTGO_LoRa32_V1)
        return GetPinmap_ttgo_lora32_v1();
#elif defined(ARDUINO_HELTEC_WIRELESS_STICK) || defined(Wireless_Stick) || defined(Wireless_Stick_Lite)
