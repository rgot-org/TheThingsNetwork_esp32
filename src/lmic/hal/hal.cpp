...
static const TTN_esp32_LMIC::HalPinmap_t *plmic_pins;
static TTN_esp32_LMIC::HalConfiguration_t *pHalConfig;
static TTN_esp32_LMIC::HalConfiguration_t nullHalConig;
...
void hal_init (void) {
    ...
    TTN_esp32_LMIC::hal_init_with_pinmap(&lmic_pins);
}
...
void hal_init_ex (const void *pContext) {
    ...
    if (! TTN_esp32_LMIC::hal_init_with_pinmap(pHalPinmap)) {
...
uint8_t hal_getTxPowerPolicy(
    ...
    return (uint8_t) pHalConfig->getTxPowerPolicy(
                        TTN_esp32_LMIC::HalConfiguration_t::TxPowerPolicy_t(inputPolicy),
                        requestedPower,
                        frequency
                        );
}
